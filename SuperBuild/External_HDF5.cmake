...
if(NOT DEFINED HDF5_DIR AND NOT Slicer_USE_SYSTEM_${proj})
  ...
  set(HDF5_CACHE_DIR ${EP_BINARY_DIR})
  set(HDF5_INSTALL_DIR ${EP_INSTALL_DIR})
...
ExternalProject_Message(${proj} "HDF5_CACHE_DIR: ${HDF5_CACHE_DIR}")
ExternalProject_Message(${proj} "HDF5_INSTALL_DIR: ${HDF5_INSTALL_DIR}")
